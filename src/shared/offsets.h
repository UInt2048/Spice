...
void populate_offsets(offsets_t *liboffsets, struct offset_struct *offsets);
...
#define OFF_ANCHOR                                                         0x80437798 // on 10.3.4, "serverperfmode", str r1, [r5, 0x3c] near top of function
...
#define OFF_ANCHOR                                   (0xfffffff00761d968 & 0xfffffff) // "unable to determine boot cpu!" in kernelcache, str x9, [x23, 0x78] below, take the lower 7 bits of value in x9 (the registers may vary for you, use instruction info if the #offset in Ghidra is making it hard to see)
#define OFF_IOUC_IPC                                                             0x9c

// iPhone 5S (GSM) (iPhone6,1), iOS 11.2.6
#elif (N51AP & IOS_11_2_6)
#define OFF_KERNEL_IMAGE_BASE                                      0xfffffff007004000 // static
#define OFF_COPYIN                                                 0xfffffff007198b14 // symbol (_copyin)
#define OFF_COPYOUT                                                0xfffffff007198d44 // symbol (_copyout)
#define OFF_CURRENT_TASK                                           0xfffffff0070e41f4 // symbol (_current_task)
#define OFF_GET_BSDTASK_INFO                                       0xfffffff0070f978c // symbol (_get_bsdtask_info)
#define OFF_VM_MAP_WIRE_EXTERNAL                                   0xfffffff007143cd8 // symbol (_vm_map_wire_external)
#define OFF_VFS_CONTEXT_CURRENT                                    0xfffffff0071ed630 // symbol (_vfs_context_current)
#define OFF_VNODE_LOOKUP                                           0xfffffff0071cf1ac // symbol (_vnode_lookup)
#define OFF_OSUNSERIALIZEXML                                       0xfffffff0074c3928 // symbol (__Z16OSUnserializeXMLPKcPP8OSString)
#define OFF_PROC_FIND                                              0xfffffff0073db4dc // symbol (_proc_find)
#define OFF_PROC_RELE                                              0xfffffff0073db44c // symbol (_proc_rele)
#define OFF_SMALLOC                                                0xfffffff006851aec // found by searching for "sandbox memory allocation failure"
#define OFF_IPC_PORT_ALLOC_SPECIAL                                 0xfffffff0070a8368 // \"ipc_processor_init\" in processor_start -> call above
#define OFF_IPC_KOBJECT_SET                                        0xfffffff0070bd4b4 // above _mach_msg_send_from_kernel_proper (2nd above for 10.3.4)
#define OFF_IPC_PORT_MAKE_SEND                                     0xfffffff0070a7df4 // first call in long path of KUNCUserNotificationDisplayFromBundle
#define OFF_ADD_X0_X0_RET                                          0xfffffff0073b1900 // gadget (or _csblob_get_cdhash)
#define OFF_KERNEL_TASK                                            0xfffffff007624048 // symbol (_kernel_task)
#define OFF_KERN_PROC                                              0xfffffff0076240a0 // symbol (_kernproc)
#define OFF_ROOTVNODE                                              0xfffffff007624088 // symbol (_rootvnode)
#define OFF_REALHOST                                               0xfffffff0075b8b98 // _host_priv_self -> adrp addr
#define OFF_ZONE_MAP                                               0xfffffff0075d5e50 // str 'zone_init: kmem_suballoc failed', first qword above 
#define OFF_OSBOOLEAN_TRUE                                         0xfffffff007622600 // __ZN9OSBoolean11withBooleanEb -> first adrp addr (isn't used anywhere tho)
#define OFF_TRUST_CACHE                                            0xfffffff00768f828 // (on iOS 10.3.4, use "%s: trust cache already loaded with matching UUID, ignoring\n", store below call to _lck_mtx_lock in same function) "%s: trust cache loaded successfully.\n" store above
#define OFF_IOSURFACE_ROOT_USERCLIENT                              0xfffffff006e77548 // (on iOS 10.3.4, search "IOSurfaceRootUserClient", store in function below first reference) 'iometa -Csov IOSurfaceRootUserClient kernel', vtab=...
#define OFF_IS_TASK                                                              0x28 // "ipc_task_init", lower of two final offsets to a local variable in decompiled code
#define OFF_TASK_ITK_SELF                                                        0xe0 // VERIFY: first reference of "ipc_task_reset", offset after _lck_mtx_lock
#define OFF_ITK_REGISTERED                                                      0x2f0 // "ipc_task_init", first comparison below to parameter, first str offset in not zero branch
#define OFF_IPR_SIZE                                                              0x8 // VERIFY: "ipc_object_copyout_dest: strange rights", offset of second ldr in function below (ipc_port_request->name->size, long path: search all instances of 0x10000003 to find _kernel_rpc_mach_port_construct_trap, needs to have a copyin call, and travel chain)
#define OFF_SIZEOF_TASK                                                         0x5c8 // VERIFY: str "tasks", mov offset below (size of entire task struct)
#define OFF_PROC_TASK                                                            0x18 // VERIFY: "PMTellAppWithResponse - Suspended", second offset above (proc->task)
#define OFF_PROC_P_CSFLAGS                                                      0x2a8 // VERIFY: _cs_restricted, first ldr offset (proc->p_csflags)
#define OFF_TASK_T_FLAGS                                                        0x3a0 // VERIFY: __ZN12IOUserClient18clientHasPrivilegeEPvPKc, in equal to 0 branch of foregroud strncmp, in function on iOS 10 (task->t_flags)
#define OFF_TASK_ALL_IMAGE_INFO_ADDR                                            0x3a8 // VERIFY: "created task is not a member of a resource coalition", search 0x5f (task->all_image_info_addr, theoretically just +0x8 from t_flags)
#define OFF_TASK_ALL_IMAGE_INFO_SIZE                                            0x3b0 // VERIFY: "created task is not a member of a resource coalition", search 0x5f (task->all_image_info_size, theoretically just +0x10 from t_flags)
#define OFF_CREATE_OUTSIZE                                                      0xbc8 // TODO: prove this
#define OFF_CREATE_SURFACE                                                          0 // static, IOSurfaceCreate is method 0 of IOSurfaceRootUserClient
#define OFF_SET_VALUE                                                               9 // static, IOSurfaceSetValue is method 9 of IOSurfaceRootUserClient
#define OFF_ANCHOR                                   (0xfffffff0075fb903 & 0xfffffff) // "unable to determine boot cpu!" in kernelcache, str x9, [x23, 0x78] below, take the lower 7 bits of value in x9 (the registers may vary for you, use instruction info if the #offset in Ghidra is making it hard to see)
#define OFF_IOUC_IPC                                                             0x9c
...
#define OFF_DNS4_ARRAY_TO_LCCONF             -(OFF_ISAKMP_CFG_CONFIG_DNS4-OFF_LCCONF) // -((isakmp_cfg_config_addr()+0x28-4*8)-lcconf_addr())
#define OFF_STR_BUFF                                                                8 // based on the pivot gadget below (the x21 gadget will do a double deref based on specific value on a buffer we control so we need to know it's offset)
#define OFF_MAX_SLIDE                                                       0x5b44000 // read 8 bytes at OFF_OLD_CACHE_ADDR + 0xf0
#define OFF_SLIDE_VALUE                                                        0x4000 // hardcode that one
...
#define OFF_OLD_CACHE_ADDR                                                0x180000000 // the first unslid address of the dyld shared cache
#define OFF_NEW_CACHE_ADDR                                                0x1c0000000 // you might want to change this because it might not work on the 5S but it should be fine for us
#define OFF_BEAST_GADGET                                                  0x1a0817b40 // search the dyld cache for e4 03 16 aa e5 03 14 aa e6 03 15 aa e7 03 13 aa e0 03 1a aa e1 03 19 aa e2 03 18 aa e3 03 17 aa 60 03 3f d6 fd 7b 47 a9 f4 4f 46 a9 f6 57 45 a9 f8 5f 44 a9 fa 67 43 a9 fc 6f 42 a9 e9 23 41 6d ff 03 02 91 c0 03 5f d6
...
#define OFF_CBZ_X0_X16_LOAD                                         0x1b0b53000+0xb18 // decode the gadget above there will be a jump, follow that jump and decode the adrp and add there
...
#define OFF_ERRNO             0x1b2058000+0xfe0+OFF_NEW_CACHE_ADDR-OFF_OLD_CACHE_ADDR // we can get that by getting a raw syscall (for example __mmap, then searching for a branch following that and then searching for an adrp and a str)
#define OFF_NDR_RECORD              0x1b07d0018+OFF_NEW_CACHE_ADDR-OFF_OLD_CACHE_ADDR // address of label _NDR_record, we need to map it before using it
