...
static UIButton *jbButton, *restoreButton;
...
- (void)loadView
{
    ...
    addButton(restoreButton, @"Restore RootFS", UICOLOR(110, 59, 38, 1.0), UICOLOR(35, 75, 155, 1.0), 30, @selector(actionRootFS), 1.0, 1.5);
#endif
