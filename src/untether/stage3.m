...
#define STD_OUT 1
#define STD_ERR 2
#define LOG(str) do { char* buf = str "\n"; size_t i = 0; while (buf[i++] != '\n'); write(STD_ERR, buf, i); } while(0)
...
#define LOG_HEX32(str, hex) do { logstr = str; hex64 = hex; goto log2_format_hex32; } while(0)
#define LOG_HEX64(str, hex) do { logstr = str; hex64 = hex; goto log2_format_hex64; } while(0)
#define VERIFY_HEX64(reject, pass, hex) do { fail = reject "\n"; logstr = pass; hex64 = hex; goto verify; } while(0)
#define VERIFY_MACH(str) do { logstr = str; goto mach_error_verify; } while(0)
...
#undef VERIFY_MACH
    ...
    log2_format_hex64:
    len = -1;
    while (logstr[++len] != '\0') formatbuf[len] = logstr[len];
    formatbuf[len + 0] = '0';
    formatbuf[len + 1] = 'x';
    formatbuf[len + 18] = '\n';
    formatbuf[len + 19] = '\0';
    ...
    while (logstr[len + (++i)] != '\0') formatbuf[len + i] = logstr[i];
    len += (i + 2);
    formatbuf[len - 2] = ')';
    formatbuf[len - 1] = '\n';
    formatbuf[len] = '\0';
...
#define ERR_32(str, hex) do { errbit = true; logstr = str; hex64 = hex; goto log_hex32; } while(0)
#define ERR_64(str, hex) do { errbit = true; logstr = str; hex64 = hex; goto log_hex32; } while(0)
#define HEX_32(str, hex) do { logstr = str; hex64 = hex; goto log_hex32; } while(0)
#define HEX_64(str, hex) do { logstr = str; hex64 = hex; goto log_hex32; } while(0)
#define VERIFY_MACH(str) do { logstr = str; goto log_err_mach; } while(0)
