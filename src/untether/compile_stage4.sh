...
$(< ./sdk.txt) clang -mios-version-min=10.0 -arch "$(< ./arch.txt)" -I../../include -larchive -framework IOKit -framework UIKit ../../submodules/libjake/img4lib/libimg4.a ../../submodules/libjake/libjake.a stage4.m uland_offsetfinder.m ../shared/*.m ../shared/realsym.c -framework Foundation -framework Security -I../ -I ../../submodules/libjake/src/ -I ../../submodules/libjake/img4lib/libvfs/ -L../../submodules/libjake/img4lib/ -L../../submodules/libjake/img4lib/lzfse/build/bin -o ./generated/stage4 && jtool --sign --inplace ./generated/stage4 && jtool --sig ./generated/stage4
