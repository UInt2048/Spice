...
echo -e -n $(codesign --display -vvv ./generated/stage3.dylib 2>/dev/stdout | grep "CDHash=" | sed 's/CDHash=//; s/../&,0x/g; s/,0x$//') >> ./generated/stage2_hash3.h
...
echo $(nm ./generated/stage3.dylib | grep "_where_it_all_starts" | sed 's/[^0-9a-f].*$//g; s/^0*/#define STAGE3_JUMP 0x/g') >> ./generated/install_stage3_offsets.h
echo -e $(jtool --sig ./generated/stage3.dylib | grep "Blob at offset" | sed 's/ (/\\n#define STAGE3_CSBLOB_SIZE /; s/ by.*$/\\n#endif/; s/Blob.*: /#define STAGE3_CSBLOB /') >> ./generated/install_stage3_offsets.h
